...
export default function Tweet({
  ...
  return (
    <div className="tweet rounded-lg border border-neutral-800 dark:border-neutral-200 px-6 py-4 my-4 bg-neutral-900 dark:bg-white max-w-xl mx-auto">
      <div className="flex items-center">
        ...
        >
          <span
            className="flex items-center font-semibold !text-neutral-100 dark:!text-neutral-900 leading-5 tracking-tight"
            title={author.name}
          >
            {author.name}
            {author.verified ? (
          ...
          <span
            className="text-sm !text-neutral-400 dark:!text-neutral-500 leading-4"
      ...
      <div className="mt-4 mb-1 leading-normal whitespace-pre-wrap  !text-neutral-200 dark:!text-neutral-700">
        {formattedText}
      </div>
      {media && media.length ? (
        <div
      ...
      <a
        className="!text-neutral-400 dark:!text-neutral-500 text-sm !hover:underline"
        href={tweetUrl}
        target="_blank"
        rel="noopener noreferrer"
      >
      ...
      <div className="flex text-sm mt-2">
        <a
          className="flex items-center mr-4 !text-neutral-400 dark:!text-neutral-500 hover:!text-blue-600 transition !hover:underline"
          href={replyUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="flex items-center mr-4 !text-neutral-400 dark:!text-neutral-500 hover:!text-green-600 transition !hover:underline"
          href={retweetUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          className="flex items-center !text-neutral-400 dark:!text-neutral-500 hover:!text-red-600 transition !hover:underline"
          href={likeUrl}
          target="_blank"
          rel="noopener noreferrer"
        >
